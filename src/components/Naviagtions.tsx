...
import {AiOutlineMenuFold, AiOutlineMenuUnfold, AiOutlineBars, AiFillTool} from "react-icons/ai";
import {GiField, GiLog} from "react-icons/gi";
import {BiLeaf, BiLogOut, BiNote} from "react-icons/bi";
...
export function Navigation() {
    ...
    return (
        <aside className={`bg-green-700 text-white ${collapsed ? "w-20" : "w-64"} h-screen transition-all duration-300`}>
            <div className="flex items-center justify-between p-4 bg-green-100">
                ...
                <button onClick={() => setCollapsed(!collapsed)} className="text-black p-2">
