...
export function EquipmentPage() {
    ...
    const filteredEquipment = equipmentList.filter((e: EquipmentModel) => {
        const lowercasedQuery = searchQuery.toLowerCase();
        return (
            e.equipmentName.toLowerCase().includes(lowercasedQuery) ||
            e.equipmentType.toLowerCase().includes(lowercasedQuery)
        );
    });
    const dataSource = filteredEquipment.map((equipment: EquipmentModel, index: number) => ({
        key: index.toString(),
        ...
        <div className="container mx-auto p-6" style={{maxHeight: "calc(100vh - 100px)"}}>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between mb-4">
                <div className="flex-grow flex justify-center mb-4 sm:mb-0">
                    ...
                    <SearchBarComponent placeHolder={"Search Equipment..."} onSearch={setSearchQuery}/>
                </div>
